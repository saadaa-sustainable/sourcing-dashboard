...
const COLS: Column<EeProductMaster>[] = [
  ...
  { key: 'product_state', label: 'Product State', kind: 'text', info: "WHAT: where the product is in its life.\n\nHOW: from the master — Ongoing (selling), NPD (new, launched), NPD Not Launched Yet, SKU-Create, To Be Discontinued, Discontinued.\n\nMIND: this is the STATE. The sales class (A/B/C/D) is a separate measure of speed — a D-class product is not discontinued unless someone approves it on the Discontinue page." },
  ...
  { key: 'rm_fabric_sku', label: 'RM Fabric SKU', kind: 'mono', info: "WHAT: the undyed fabric this product is cut from.\n\nHOW: the greige fabric code from the master.\n\nUSE: links the product to the Fabric Master and the material buying plan." },
  { key: 'dyed_fabric_sku', label: 'Dyed Fabric SKU', kind: 'mono', info: "WHAT: the dyed or finished fabric this product uses.\n\nHOW: greige fabric + colour, as a dyed-fabric code.\n\nUSE: what Job Work vendors are issued." },
  ...
  { key: 'replenishment_type', label: 'Replen. Type', kind: 'text', info: "WHAT: whether this product is meant to be reordered.\n\nHOW: replenishment type from the master — continuous vs one-time / seasonal.\n\nUSE: a one-time product going out of stock is expected; a continuous one is a stock-out." },
  ...
  { key: 'fabric_consumption_average', label: 'Fabric Cons. Avg', kind: 'num', info: "WHAT: metres of fabric one piece takes.\n\nHOW: the approved average consumption from the master.\n\nUSE: the benchmark cutting is checked against on the Cutting Register." },
  ...
  { key: 'qty_in_meters', label: 'Qty in Meters', kind: 'text', info: "WHAT: gender + wear type, e.g. 'F TOP WEAR'.\n\nHOW: an EasyEcom field whose name says 'qty in metres' but which actually holds gender and wear type.\n\nMIND: not a metre quantity, whatever the column is called. Fabric consumption is the column to its left." },
  { key: 'related_ongoing_product', label: 'Related Ongoing', kind: 'mono', info: "WHAT: the existing product this new one replaces or extends.\n\nHOW: the related ongoing product from the master.\n\nUSE: lets the new product borrow the old one's demand history until it has its own." },
