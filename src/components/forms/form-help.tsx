...
const HELP: Record<string, HelpItem[]> = {
  '/buying-plan': [
    ...
    { field: 'Standard cost (J / F / E)', source: 'Standard Cost sheet', detail: 'The approved job / FOB / E-FOB rates for the product, read-only. Shows “—” until a standard cost is approved.' },
  ...
  '/po-approval': [
    ...
    { field: 'Critical stage dates', source: 'You enter', detail: 'PP sample due, GPT due, cutting start, inline QC due, and the critical-path first delivery date. These feed TNA / high-risk.' },
