...
const HELP: Record<string, HelpItem[]> = {
  ...
  '/vendor-recommendation': [
    ...
    { field: 'Score', source: 'Automatic', formula: '0.6 × on-time(rated) + 0.4 × completion − 3 × QC-fail%', detail: 'The ranking value out of 100 — on-time reliability + completion, minus a QC-fail quality penalty (floored at 0). Vendors with fewer than 5 POs are listed separately as thin data, not ranked.' },
  ],
  '/fabric-cost': [
