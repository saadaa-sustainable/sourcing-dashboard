...
function DashboardTab({
  ...
  return (
    <>
      ...
      {/* EDD scatter last + full-width + tall: one dedicated wide row gives every
          vendor real vertical room (labels never collide) with the date axis kept
          in view — no cramming it into a half-width bento cell. */}
      <div className="chart-grid">
        <ChartCard
          wide
          tall
