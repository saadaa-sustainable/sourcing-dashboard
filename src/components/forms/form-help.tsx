...
const HELP: Record<string, HelpItem[]> = {
  ...
  '/vendor-capacity': [
    ...
    { field: 'PO capacity', source: 'Automatic', formula: 'capacity/month × lead days ÷ 30', detail: 'What the vendor can make inside one PO’s lead time — the pipeline it can legitimately hold. Example: 8,320 a month for an E-FOB vendor (45 days) → 12,480; 13,000 a month for a FOB vendor (90 days) → 39,000. This, not the month, is what on-order quantity is compared against; comparing to one month flagged every normal FOB vendor as over capacity.' },
